			...
			<div class="col-md-12 col-lg-6 col-xl-3">
				...
				<div class="m-widget24">
					<div class="m-widget24__item">
				        ...
				        <div class="m--space-10"></div>
						<div class="progress m-progress--sm">
							<div class="progress-bar m--bg-danger" role="progressbar" style="width: {{ round($stats['cashHour']/$stats['scheduledHourCash'],2)*100 }}%;" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
						</div>
						<span class="m-widget24__change">
							有效工时率
						</span>
