		...
		<div class="m-portlet__head-caption">
			<div class="m-portlet__head-title">
				...
				<h3 class="m-portlet__head-text">
					Review Report for {{$employeeReview->employee->name}} 
				</h3>
			</div>
		</div>
	...
	<form class="m-form m-form--fit m-form--label-align-right ">
		...
		<div class="m-form__group form-group row" >
				<label class="col-2 col-form-label">知识考试通过</label>
										<div class="col-2">
											<label v-if="examPassed" class="col-2 col-form-label m--font-success"><i class="fa fa-check fa-lg"></i></label>
											<label v-else class="col-2 col-form-label m--font-danger"><i class="fa fa-times fa-lg"></i></label>
										</div>
		</div>
					...
					<div class="form-group m-form__group row">
						...
						<div class="col-2">
							<input v-model="performance" class="form-control m-input" disabled>
						</div>
						<div class="col-8">
...
<script>
 app = new Vue({
	el:'#root',
	data:{
		verified: {{ $employeeReview->verified}},
		id: {{$employeeReview->id}},
		employee: {{ $employeeReview->employee->id }},
		manager_id: {{ $employeeReview->employee->location->manager->id}},
		performance: {{ $employeeReview->performance }},
		managerScore: {{ $employeeReview->manager_score }},
		selfScore: {{ $employeeReview->self_score }},
		action: null,
		reviewDate:'{{ $employeeReview->reviewDate }}',
		nextDate: '{{ $employeeReview->nextReview }}',
		managerNote: '{{ $employeeReview->manager_note }}',
		selfNote:'{{ $employeeReview->self_note }}',
		examPassed:{{ $employeeReview->pass }},
